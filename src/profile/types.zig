...
pub fn type_value_name(type_id: TypeId, value: u64) ?[]const u8 {
    return switch (type_id) {
        ...
        .file_flags => switch (value) {
            2 => "read",
            4 => "write",
            8 => "erase",
            else => null,
        },
        .mesg_count => switch (value) {
            0 => "num_per_file",
            1 => "max_per_file",
            2 => "max_per_file_type",
            else => null,
        },
        .date_time => switch (value) {
            268435456 => "min",
            else => null,
        },
        .local_date_time => switch (value) {
            268435456 => "min",
            else => null,
        },
        .message_index => switch (value) {
            32768 => "selected",
            28672 => "reserved",
            4095 => "mask",
            else => null,
        },
        .device_index => switch (value) {
            0 => "creator",
            else => null,
        },
        .gender => switch (value) {
        ...
        .display_measure => switch (value) {
            0 => "metric",
            1 => "statute",
            2 => "nautical",
            else => null,
        },
        .display_heart => switch (value) {
            0 => "bpm",
            1 => "max",
            2 => "reserve",
            else => null,
        },
        .display_power => switch (value) {
            0 => "watts",
            1 => "percent_ftp",
            else => null,
        },
        .display_position => switch (value) {
            0 => "degree",
            1 => "degree_minute",
        ...
        .sport_bits_6 => switch (value) {
            1 => "floor_climbing",
            else => null,
        },
        .sub_sport => switch (value) {
            0 => "generic",
            1 => "treadmill",
            2 => "street",
            3 => "trail",
        ...
        .date_mode => switch (value) {
            0 => "day_month",
            1 => "month_day",
            else => null,
        },
        .backlight_timeout => switch (value) {
            0 => "infinite",
            else => null,
        },
        .event => switch (value) {
        ...
        .timer_trigger => switch (value) {
            0 => "manual",
            1 => "auto",
            2 => "fitness_equipment",
            else => null,
        },
        .fitness_equipment_state => switch (value) {
            0 => "ready",
            1 => "in_use",
            2 => "paused",
            3 => "unknown",
        ...
        .activity_class => switch (value) {
            127 => "level",
            100 => "level_max",
            128 => "athlete",
            else => null,
        },
        .hr_zone_calc => switch (value) {
            0 => "custom",
            1 => "percent_max_hr",
            2 => "percent_hrr",
            3 => "percent_lthr",
        ...
        .pwr_zone_calc => switch (value) {
            0 => "custom",
            1 => "percent_ftp",
            else => null,
        },
        .wkt_step_duration => switch (value) {
            0 => "time",
            1 => "distance",
            2 => "hr_less_than",
            3 => "hr_greater_than",
        ...
        .goal_source => switch (value) {
            0 => "auto",
            1 => "community",
            2 => "user",
            else => null,
        },
        .schedule => switch (value) {
            0 => "workout",
            1 => "course",
            else => null,
        },
        .course_point => switch (value) {
            0 => "generic",
            1 => "summit",
            2 => "valley",
            3 => "water",
        ...
        .antplus_device_type => switch (value) {
            1 => "antfs",
            11 => "bike_power",
        ...
        .workout_capabilities => switch (value) {
            1 => "interval",
            2 => "custom",
            4 => "fitness_equipment",
            8 => "firstbeat",
        ...
        .hr_type => switch (value) {
            0 => "normal",
            1 => "irregular",
            else => null,
        },
        .course_capabilities => switch (value) {
            1 => "processed",
            2 => "valid",
            4 => "time",
            8 => "distance",
        ...
        .workout_hr => switch (value) {
            100 => "bpm_offset",
            else => null,
        },
        .workout_power => switch (value) {
            1000 => "watts_offset",
            else => null,
        },
        .bp_status => switch (value) {
            0 => "no_error",
        ...
        .left_right_balance => switch (value) {
            127 => "mask",
            128 => "right",
            else => null,
        },
        .left_right_balance_100 => switch (value) {
            16383 => "mask",
            32768 => "right",
            else => null,
        },
        .length_type => switch (value) {
            0 => "idle",
            1 => "active",
            else => null,
        },
        .day_of_week => switch (value) {
            0 => "sunday",
            1 => "monday",
            2 => "tuesday",
            3 => "wednesday",
        ...
        .connectivity_capabilities => switch (value) {
            1 => "bluetooth",
            2 => "bluetooth_le",
            4 => "ant",
            8 => "activity_upload",
        ...
        .weather_report => switch (value) {
            0 => "current",
            1 => "forecast",
            2 => "daily_forecast",
            else => null,
        },
        .weather_status => switch (value) {
            0 => "clear",
            1 => "partly_cloudy",
            2 => "mostly_cloudy",
            3 => "rain",
        ...
        .weather_severe_type => switch (value) {
            0 => "unspecified",
            1 => "tornado",
            2 => "tsunami",
            3 => "hurricane",
        ...
        .segment_lap_status => switch (value) {
            0 => "end",
            1 => "fail",
            else => null,
        },
        .segment_leaderboard_type => switch (value) {
            0 => "overall",
            1 => "personal_best",
            2 => "connections",
            3 => "group",
        ...
        .segment_delete_status => switch (value) {
            0 => "do_not_delete",
            1 => "delete_one",
            2 => "delete_all",
            else => null,
        },
        .segment_selection_type => switch (value) {
            0 => "starred",
            1 => "suggested",
            else => null,
        },
        .source_type => switch (value) {
            0 => "ant",
            1 => "antplus",
            2 => "bluetooth",
        ...
        .local_device_type => switch (value) {
            0 => "gps",
            1 => "glonass",
            2 => "gps_glonass",
            3 => "accelerometer",
        ...
        .display_orientation => switch (value) {
            0 => "auto",
            1 => "portrait",
            2 => "landscape",
            3 => "portrait_flipped",
        ...
        .workout_equipment => switch (value) {
            0 => "none",
            1 => "swim_fins",
            2 => "swim_kickboard",
            3 => "swim_paddles",
        ...
        .digital_watchface_layout => switch (value) {
            0 => "traditional",
            1 => "modern",
            2 => "bold",
            else => null,
        },
        .analog_watchface_layout => switch (value) {
            0 => "minimal",
            1 => "traditional",
            2 => "modern",
            else => null,
        },
        .rider_position_type => switch (value) {
            0 => "seated",
            1 => "standing",
        ...
        .camera_event_type => switch (value) {
            0 => "video_start",
            1 => "video_split",
            2 => "video_end",
            3 => "photo_taken",
        ...
        .bike_light_network_config_type => switch (value) {
            0 => "auto",
            4 => "individual",
            5 => "high_visibility",
            6 => "trail",
        ...
        .comm_timeout_type => switch (value) {
        ...
        .camera_orientation_type => switch (value) {
        ...
        .attitude_validity => switch (value) {
        ...
        .auto_sync_frequency => switch (value) {
            0 => "never",
            1 => "occasionally",
            2 => "frequent",
            3 => "once_a_day",
        ...
        .auto_activity_detect => switch (value) {
            0 => "none",
            1 => "running",
            2 => "cycling",
            4 => "swimming",
        ...
        .supported_exd_screen_layouts => switch (value) {
            1 => "full_screen",
            2 => "half_vertical",
            4 => "half_horizontal",
        ...
        .bike_light_beam_angle_mode => switch (value) {
            0 => "manual",
            1 => "auto",
            else => null,
        },
        .fit_base_unit => switch (value) {
            0 => "other",
            1 => "kilogram",
            2 => "pound",
            else => null,
        },
        .set_type => switch (value) {
            0 => "rest",
            1 => "active",
            else => null,
        },
        .max_met_category => switch (value) {
            0 => "generic",
            1 => "cycling",
            else => null,
        },
        .exercise_category => switch (value) {
            0 => "bench_press",
            1 => "calf_raise",
            2 => "cardio",
            3 => "carry",
        ...
        .bench_press_exercise_name => switch (value) {
        ...
        .calf_raise_exercise_name => switch (value) {
            0 => "3_way_calf_raise",
        ...
        .cardio_exercise_name => switch (value) {
        ...
        .carry_exercise_name => switch (value) {
            0 => "bar_holds",
            1 => "farmers_walk",
        ...
        .chop_exercise_name => switch (value) {
        ...
        .core_exercise_name => switch (value) {
            0 => "abs_jabs",
            1 => "weighted_abs_jabs",
        ...
        .crunch_exercise_name => switch (value) {
            0 => "bicycle_crunch",
            1 => "cable_crunch",
        ...
        .curl_exercise_name => switch (value) {
        ...
        .deadlift_exercise_name => switch (value) {
            0 => "barbell_deadlift",
        ...
        .flye_exercise_name => switch (value) {
            0 => "cable_crossover",
        ...
        .hip_raise_exercise_name => switch (value) {
        ...
        .hip_stability_exercise_name => switch (value) {
        ...
        .hip_swing_exercise_name => switch (value) {
        ...
        .hyperextension_exercise_name => switch (value) {
        ...
        .lateral_raise_exercise_name => switch (value) {
        ...
        .leg_curl_exercise_name => switch (value) {
            0 => "leg_curl",
            1 => "weighted_leg_curl",
            2 => "good_morning",
        ...
        .leg_raise_exercise_name => switch (value) {
        ...
        .lunge_exercise_name => switch (value) {
            0 => "overhead_lunge",
            1 => "lunge_matrix",
        ...
        .olympic_lift_exercise_name => switch (value) {
        ...
        .plank_exercise_name => switch (value) {
            0 => "45_degree_plank",
        ...
        .plyo_exercise_name => switch (value) {
        ...
        .pull_up_exercise_name => switch (value) {
            0 => "banded_pull_ups",
        ...
        .push_up_exercise_name => switch (value) {
        ...
        .row_exercise_name => switch (value) {
        ...
        .shoulder_press_exercise_name => switch (value) {
        ...
        .shoulder_stability_exercise_name => switch (value) {
        ...
        .shrug_exercise_name => switch (value) {
        ...
        .sit_up_exercise_name => switch (value) {
        ...
        .squat_exercise_name => switch (value) {
            0 => "leg_press",
        ...
        .total_body_exercise_name => switch (value) {
            0 => "burpee",
            1 => "weighted_burpee",
            2 => "burpee_box_jump",
        ...
        .move_exercise_name => switch (value) {
            0 => "arch_and_curl",
        ...
        .pose_exercise_name => switch (value) {
            0 => "all_fours",
            1 => "ankle_to_knee",
            2 => "baby_cobra",
            3 => "boat",
        ...
        .triceps_extension_exercise_name => switch (value) {
            0 => "bench_dip",
        ...
        .warm_up_exercise_name => switch (value) {
            0 => "quadruped_rocking",
            1 => "neck_tilts",
            2 => "ankle_circles",
        ...
        .run_exercise_name => switch (value) {
            0 => "run",
            1 => "walk",
            2 => "jog",
            3 => "sprint",
        ...
        .bike_exercise_name => switch (value) {
            0 => "bike",
            1 => "ride",
            2 => "sprint",
            else => null,
        },
        .banded_exercises_exercise_name => switch (value) {
            1 => "ab_twist",
            2 => "back_extension",
            3 => "bicycle_crunch",
            4 => "calf_raises",
        ...
        .battle_rope_exercise_name => switch (value) {
        ...
        .elliptical_exercise_name => switch (value) {
            0 => "elliptical",
            else => null,
        },
        .floor_climb_exercise_name => switch (value) {
            0 => "floor_climb",
            else => null,
        },
        .indoor_bike_exercise_name => switch (value) {
            0 => "air_bike",
            1 => "assault_bike",
            3 => "stationary_bike",
            else => null,
        },
        .indoor_row_exercise_name => switch (value) {
            0 => "rowing_machine",
            else => null,
        },
        .ladder_exercise_name => switch (value) {
            0 => "agility",
            1 => "speed",
            else => null,
        },
        .sandbag_exercise_name => switch (value) {
            0 => "around_the_world",
            1 => "back_squat",
        ...
        .sled_exercise_name => switch (value) {
            0 => "backward_drag",
            1 => "chest_press",
            2 => "forward_drag",
            3 => "low_push",
        ...
        .sledge_hammer_exercise_name => switch (value) {
            0 => "lateral_swing",
            1 => "hammer_slam",
            else => null,
        },
        .stair_stepper_exercise_name => switch (value) {
            0 => "stair_stepper",
            else => null,
        },
        .suspension_exercise_name => switch (value) {
            0 => "chest_fly",
            1 => "chest_press",
            2 => "crunch",
            3 => "curl",
        ...
        .tire_exercise_name => switch (value) {
            0 => "flip",
            else => null,
        },
        .bike_outdoor_exercise_name => switch (value) {
            0 => "bike",
            else => null,
        },
        .run_indoor_exercise_name => switch (value) {
            0 => "indoor_track_run",
            1 => "treadmill",
            else => null,
        },
        .water_type => switch (value) {
            0 => "fresh",
            1 => "salt",
            2 => "en13319",
            3 => "custom",
        ...
        .tissue_model_type => switch (value) {
            0 => "zhl_16c",
            else => null,
        },
        .dive_gas_status => switch (value) {
            0 => "disabled",
            1 => "enabled",
            2 => "backup_only",
            else => null,
        },
        .dive_alert => switch (value) {
            0 => "ndl_reached",
        ...
        .dive_alarm_type => switch (value) {
            0 => "depth",
            1 => "time",
            2 => "speed",
            else => null,
        },
        .dive_backlight_mode => switch (value) {
            0 => "at_depth",
            1 => "always_on",
            else => null,
        },
        .sleep_level => switch (value) {
            0 => "unmeasurable",
            1 => "awake",
            2 => "light",
            3 => "deep",
        ...
        .spo2_measurement_type => switch (value) {
            0 => "off_wrist",
            1 => "spot_check",
            2 => "continuous_check",
            3 => "periodic",
        ...
        .ccr_setpoint_switch_mode => switch (value) {
            0 => "manual",
            1 => "automatic",
            else => null,
        },
        .dive_gas_mode => switch (value) {
            0 => "open_circuit",
            1 => "closed_circuit_diluent",
            else => null,
        },
        .projectile_type => switch (value) {
            0 => "arrow",
            1 => "rifle_cartridge",
            2 => "pistol_cartridge",
            3 => "shotshell",
        ...
        .favero_product => switch (value) {
            10 => "assioma_uno",
            12 => "assioma_duo",
            else => null,
        },
        .split_type => switch (value) {
            1 => "ascent_split",
            2 => "descent_split",
            3 => "interval_active",
            4 => "interval_rest",
        ...
        .climb_pro_event => switch (value) {
            0 => "approach",
            1 => "start",
            2 => "complete",
            else => null,
        },
        .gas_consumption_rate_type => switch (value) {
            0 => "pressure_sac",
            1 => "volume_sac",
            2 => "rmv",
            else => null,
        },
        .tap_sensitivity => switch (value) {
            0 => "high",
            1 => "medium",
            2 => "low",
            else => null,
        },
        .radar_threat_level_type => switch (value) {
            0 => "threat_unknown",
            1 => "threat_none",
        ...
        .sleep_disruption_severity => switch (value) {
            0 => "none",
            1 => "low",
            2 => "medium",
            3 => "high",
        ...
        .nap_period_feedback => switch (value) {
            0 => "none",
        ...
        .nap_source => switch (value) {
            0 => "automatic",
            1 => "manual_device",
            2 => "manual_gc",
            else => null,
        },
        .max_met_speed_source => switch (value) {
            0 => "onboard_gps",
            1 => "connected_gps",
            2 => "cadence",
            else => null,
        },
        .max_met_heart_rate_source => switch (value) {
            0 => "whr",
            1 => "hrm",
            else => null,
        },
        .hrv_status => switch (value) {
            0 => "none",
            1 => "poor",
            2 => "low",
            3 => "unbalanced",
